...
keywords = ["False", "None", "True", "and", "as", "assert", "async", "await", "break", "class", "continue", "del", "elif", "else", "except", "finally", "for", "from", "if", "import", "in", "is", "lambda", "not", "or", "pass", "raise", "return", "try", "while", "with", "yield", "func", "print_vars", "print_nones", "print_all", "protected", "private", "self", "spawn", "'s", "f", "var", "print_python", "when", "when~once", "keyword", "do", "end"]

libraries = ["asyncio", "types", "threading", "json", "os", "keyboard", "subprocess", "time"]

symbols = sorted(set([
"False", "None", "True", "and", "as", "assert", "async", "await", "break", "class", "continue", "del", "elif", "else", "except", "finally", "for", "from", "if", "import", "in", "is", "lambda", "not", "or", "pass", "raise", "return", "try", "while", "with", "yield", "func", "print_vars", "print_nones", "print_all", "protected", "private", "self", "loop", "wait~async", "wait", "wait~thread", "wait~until", "once", "array", "dict", "random", "random_range", "spawn", "'s", "f", "embed_lua", "python", "var", "looprate", "print_python", "when", "when~once", "keyword", "key", "do", "end",
...
"asyncio", "types", "threading", "json", "os", "keyboard", "LuaRuntime", "time"
]))
...
def open_editor(filepath=None):
    ...
    def run_script():
        ...
        if platform.python_implementation() != "PyPy":
            ...
            pypy_path = os.path.abspath(os.path.join(editor_dir, "pypy", "pypy3.exe"))
            exe = pypy_path
...
# real keywords
        ...
        for kw in symbols:
            ...
            start = "1.0"
            while True:
                pos = text.search(rf"\y{kw}\y", start, stopindex=tk.END, regexp=True)
...
# libraries
        ...
        text.tag_remove("library", "1.0", tk.END)
        ...
        for f in libraries:
            ...
            while True:
                ...
                text.tag_add("library", pos, end)
                start = end
        text.tag_config("library", foreground="#00FFFF", font=("Consolas", 12, "bold"))
...
# lua contents
        ...
        fake_line = line.replace("do", "{").replace("end", "}")
        
        start = fake_line.find("{")
        end = fake_line.find("}", start)
